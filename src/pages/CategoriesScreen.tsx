...
import { useCreateCategoryMutation, useUpdateCategoryMutation, useDeleteCategoryMutation, useGetCategoriesQuery, useGetAllProductsQuery } from '@/hooks'
    ...
    <div className="flex flex-1 flex-col gap-5 overflow-y-auto p-4 lg:overflow-hidden lg:p-6">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div className="flex flex-col overflow-hidden rounded-2xl border border-stone-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          <div className="shrink-0 border-b border-stone-100 px-5 py-4 dark:border-zinc-800">
            <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">
              {editingId ? 'Edit category' : 'New category'}
            </h3>
          </div>

          {/* Mobile: expands naturally (page scrolls). Desktop: fills card height, scrolls internally. */}
          <div className="min-h-[360px] overflow-y-auto px-5 py-5 lg:min-h-0 lg:flex-1">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              ...
              <div
                className="flex items-center justify-center rounded-xl border-2 border-dashed p-4"
        ...
        {/* ── List card ── */}
        <div className="flex flex-col overflow-hidden rounded-2xl border border-stone-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          <div className="flex shrink-0 items-center justify-between border-b border-stone-100 px-5 py-4 dark:border-zinc-800">
          ...
          {/* Mobile: min-height so it looks decent. Desktop: fills remaining card height. */}
          <div className="min-h-[280px] overflow-y-auto lg:min-h-0 lg:flex-1">
